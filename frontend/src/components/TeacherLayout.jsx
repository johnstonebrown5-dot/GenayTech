    ...
    <div className={`min-h-screen bg-gray-50 teacher-theme ${effectiveDarkMode ? 'teacher-theme-dark' : ''}`}>
      ...
      >
        ...
        <div className="ml-auto flex items-center gap-2 md:gap-3">
          ...
          <button onClick={() => navigate('/sessions')} className="hidden md:inline-flex px-3 py-1.5 rounded text-sm bg-gray-900 text-white hover:bg-gray-800 transition-colors shadow-soft">Logout</button>
        </div>
      </header>

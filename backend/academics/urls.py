...
from .views import (
    ...
    StageGradingBandViewSet, RoomViewSet, TimetableEntryViewSet, SubjectComponentViewSet, TeacherDutyViewSet,
...
router.register('stage_grading', StageGradingBandViewSet)
